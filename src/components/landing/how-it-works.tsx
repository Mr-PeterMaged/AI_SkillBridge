  ...
  return (
    <section id="how-it-works" className="border-b border-border/60 bg-muted/30">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
        ...
        <StaggerGroup className="relative mt-12 grid gap-6 sm:grid-cols-3">
          <div
          ...
          {steps.map((step, i) => (
            <StaggerItem key={step.title}>
              <motion.div
                {...hoverLift}
                className="relative h-full rounded-2xl border border-border bg-card p-6 shadow-sm transition-shadow hover:shadow-md"
              >
